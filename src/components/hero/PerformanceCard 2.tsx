...
const PerformanceCard = ({ data, position, mousePosition, inView }: PerformanceCardProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 pr-8 transition-all duration-300 hover:bg-white/[0.08] hover:border-white/20 hover:shadow-[0_8px_32px_rgba(255,255,255,0.1)]">
        ...
        <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-purple-500/20 to-blue-500/20 blur-xl opacity-0 group-hover:opacity-50 transition-opacity duration-300 -z-10" />
      </motion.div>
    </motion.div>
  );
};
